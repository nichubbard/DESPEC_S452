...
//       int    FatTDC_Multipl[FAT_VME_MAX_MULTI];
    ...
    long stopTime;
      ...
      /* Multiplexer correction */
            ...
            TH1 *hbPlas_lead_lead_ref_det1[4][bPLASTIC_CHAN_PER_DET];
            TH1 *hbPlas_lead_lead_ref_det2[4][bPLASTIC_CHAN_PER_DET];
            TH1 *hbPlas_lead_lead_ref_det3[4][bPLASTIC_CHAN_PER_DET];
...
//             TH1 *hbPlas_ToT_coinc_dets_perchan[3][32];
            ...
            TH1 *hbPlas_SC41L_Anal_lead[4][bPLASTIC_CHAN_PER_DET];
            TH1 *hbPlas_SC41R_Anal_lead[4][bPLASTIC_CHAN_PER_DET];
